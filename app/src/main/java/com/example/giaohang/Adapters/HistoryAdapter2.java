package com.example.giaohang.Adapters;
...
import com.example.giaohang.History.HistoryViewHolders;
import com.example.giaohang.Objects.HistoryObject;
import com.example.giaohang.R;

import java.util.List;

public class HistoryAdapter2 extends RecyclerView.Adapter<HistoryViewHolders> {
    private List<HistoryObject> itemList;
    private Context context;

    public HistoryAdapter2(List<HistoryObject> itemList, Context context) {
    ...
    public HistoryViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layoutView= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_history2,null,false);
