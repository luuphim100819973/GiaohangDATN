...
/**
 * Cho user chọn giữa login hoặc register fragment
 */
public class MenuFragment extends Fragment implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container,
        ...
        if (!started) {
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    .requestIdToken("878066533446-0kspv6ar797m4233fot35isovnk4rnu0.apps.googleusercontent.com")
                    //   .requestIdToken(getString(R.string))
                    .requestEmail()
                    .build();
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
            ...
            Toast.makeText(getActivity(), "Đăng nhập ko thành công", Toast.LENGTH_SHORT).show();
        }
    }
    /**
     * Đăng nhập với google credential, nếu account chưa tồn tại sẽ tự động đc tạo
     * biến credential - google auth credential
     */
